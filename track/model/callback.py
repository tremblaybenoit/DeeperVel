...
class FigureLogger(Callback):
    ...
    def on_train_epoch_end(self, trainer, model):
        ...
        # Generate figures
        self.figs.append(fig_scatterplots(target, result, title_prefix=f"Epoch {current_epoch:02d}"))
        self.figs.append(fig_patches(target, result, title_prefix=f"Epoch {current_epoch:02d}", img_range=(-2.5, 2.5)))
